  ...
  return (
    <>
      ...
      <div className="grid grid-cols-12 gap-4 mt-6">
        <div className="col-span-9 p-5 bg-white rounded-sm ">
          <div>
          ...
          {data.map((item) => (
            <div key={item.id}>
              <div className="flex justify-between p-4 mb-6 bg-white box-one">
                <div>
                  <span className="mt-2 text-base font-medium">
                    {item.type}
                  </span>
                  <div className="mt-3">
                    <span className="text-sm text-grey-4/50">Due Date:</span>{" "}
                    <span className="text-grey-4">{item.dueData}</span>
                  </div>
                </div>
                <div className="text-xs text-grey-5">
          ...
          <div className="flex justify-center">
            <button className="text-sm font-bold text-brand-blue-eight">
              Show more
            </button>
          </div>
        </div>
